-- Simple TestingVala Database Setup
...
-- Insert or update initial website content
...
DROP POLICY IF EXISTS "Users can view their own submissions" ON contest_submissions;
DROP POLICY IF EXISTS "Users can insert submissions" ON contest_submissions;
DROP POLICY IF EXISTS "Admin session access" ON admin_sessions;
