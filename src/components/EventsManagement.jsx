...
const EventsManagement = () => {
  ...
  const handleImageUpload = async (file) => {
    ...
    // Accept larger files - 10MB limit instead of 5MB
    ...
    try {
      ...
      // For new events, store file and create preview
      if (!editingEvent?.id) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingEvent) {
        ...
        // For new events, handle image upload
        if (formData.image_file) {
          ...
          try {
            ...
            // In development, fallback to adding the event locally so admin can continue testing
  ...
  const handleEdit = (event) => {
    ...
    setFormData({
      ...
      image_file: null, // Clear image file for editing
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-1">
                    <p className="text-xs text-gray-500">
                      <strong>Accepted formats:</strong> JPG, PNG, GIF, WebP, SVG, BMP
                    </p>
                    <p className="text-xs text-gray-500">
                      <strong>File size:</strong> Up to 10MB
                    </p>
                    <p className="text-xs text-gray-500">
                      <strong>Recommended:</strong> 600x400px or larger for best display
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">Professional Event Details</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, registered_count: parseInt(e.target.value) || 0 })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF6600] focus:border-transparent"
                      placeholder="0"
                      min="0"
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF6600] focus:border-transparent"
                      placeholder="Senior QA Professional"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="featured" className="ml-2 block text-sm text-gray-900">
                      Mark as featured event (shows with special badge)
                    </label>
                  </div>
                </div>
              </div>
