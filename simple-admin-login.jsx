        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="mt-6 space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-100 transition-colors font-medium"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-colors font-medium"
            >
